...
import lapitanplugins.capturebase.Boss;
...
public class FirstSkillSet implements CurrSkillSet {
    ...
    public FirstSkillSet() {
        CaptureBase.getInstance().getBoss().getBossBar().setColor(BarColor.GREEN);
        CaptureBase.getInstance().getBoss().getBoss().setSpell(Spellcaster.Spell.NONE);
    }
